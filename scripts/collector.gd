...
@export var sprite_up_inside: Texture2D
@export var sprite_left_inside: Texture2D
@export var sprite_right_inside: Texture2D
@export var sprite_down_inside: Texture2D
...
func rotate_90():
	...
	match rotation_state:
		0:
			...
			sprite_inside.texture = sprite_up_inside
		1:
			sprite.texture = sprite_right
			sprite_inside.texture = sprite_right_inside
		2:
			sprite.texture = sprite_down
			sprite_inside.texture = sprite_down_inside
		3:
			sprite.texture = sprite_left
			sprite_inside.texture = sprite_left_inside
